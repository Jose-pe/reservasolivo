    ...
    <main class="flex-grow-1 d-flex flex-column min-w-0 bg-dark-main">
        ...
        <div class="flex-grow-1 d-flex min-vh-0 position-relative overflow-hidden">
            ...
            <aside class="bg-dark-sidebar border-start border-dark-custom d-flex flex-column justify-content-between flex-shrink-0 overflow-y-auto" style="width: 360px;">
                ...
                <div class="card-header me-2"><i class="fa-solid fa-user me-2" style="color: rgb(255, 255, 255);"></i>{{$reserva->name}} <span class="badge badge bg-secondary text-white mr-2"><i class="fa-solid fa-hashtag mr-2" style="color: rgb(255, 255, 255);"> </i> <span id="id_reserva">{{$reserva->id}}</span></div>
                <div class="card-body">
                    ...
                    <span class="badge bg-success text-white me-1"><i class="fa-solid fa-users me-2" style="color: rgb(250, 250, 250);"></i>Comensales: {{$reserva->guests}}</span>  <span class="badge bg-success text-white mr-2"><i class="fa-solid fa-baby me-2" style="color: rgb(255, 255, 255);"></i>Niños: {{$reserva->kids_count}}</span><br> 
                    <span class="badge bg-warning text-dark mt-2 me-1"><i class="fa-solid fa-utensils me-2" style="color: rgb(0, 0, 0);"></i>{{$reserva->service}}</span>
                ...
                <button type="button" class="btn btn-success btn-sm me-2 ps-5 pe-5"><i class="fa-solid fa-floppy-disk me-2" style="color: rgb(255, 255, 255);"></i>Asignar</button>
